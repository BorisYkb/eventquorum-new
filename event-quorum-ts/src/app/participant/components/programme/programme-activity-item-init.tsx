// src/app/participant/components/programme/programme-activity-item-init.tsx
'use client';
...
interface ProgrammeActivityItemInitProps {
    activity: Activite;
    fontSizes: any;
    isSecondToLast?: boolean; // Nouveau prop pour identifier l'avant-dernière activité
}
 ...
 */
export function ProgrammeActivityItemInit({ activity, fontSizes, isSecondToLast = false }: ProgrammeActivityItemInitProps) {
    ...
    const handleViewDetails = () => {
        ...
        router.push(`/participant/${activity.id}`);
    };
    ...
    const getAvailablePlaces = () => {
        // Si c'est l'avant-dernière activité du jour1, retourner "10 000 FCFA"
        if (isSecondToLast) {
            return '10 000 FCFA';
        }
