// src/app/participant/enligne/activites/[id]/page.tsx
 ...
 */
/**
 * Données étendues des intervenants avec détails complets
 */
                            ...
                            <CardContent sx={{ p: { xs: 2, md: 3 } }}>
                                ...
                                <Stack spacing={2}>
                                    ...
                                    {hasNullPrices() ? (
                                        ...
                                        <Typography
                                            variant="h6"
                                            sx={{ ...fontSizes.h6, color: 'success.main', fontWeight: 700, textAlign: 'center' }}
                                        >
                                            Gratuit
                                        </Typography>
                                    ) : (
