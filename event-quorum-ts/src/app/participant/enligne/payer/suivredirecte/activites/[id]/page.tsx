// src/app/participant/enligne/payer/suivredirecte/activites/[id]/page.tsx
                ...
                {INTERVENANTS.map((intervenant, index) => (
                    <Card
                        ...
                        sx={{
                            ...
                            height: 'fit-content',
                            position: 'relative',
                            overflow: 'visible', // ✅ permet au panneau de dépasser
                            cursor: 'pointer',
                            ...
                            '&:hover': {
                                ...
                                '& .intervenant-details': {
                                    opacity: 1,
                                    visibility: 'visible',
                                    transform: 'translate(-50%, 0)', // ✅ slide up vers sa place
                                },
                            },
                        }}
                    >
                        ...
                        <Box
                            ...
                            sx={{
                                position: 'absolute',
                                top: 'calc(77% + 8px)',        // ✅ juste sous la carte
                                left: '50%',
                                transform: 'translate(-50%, 8px)', // ✅ position de départ (anim)
                                width: { xs: '92%', sm: '88%' }, // ✅ largeur contrôlée et centrée
                                maxWidth: 360,
                                ...
                                zIndex: (theme) => theme.zIndex.modal + 1, // ✅ au-dessus des cartes voisines
                        ...
                        >
                            <Typography variant="body2" sx={{ mb: 1.5, ...fontSizes.body2 }}>
                                Lorem ipsum dolor sit amet consectetur adipiscing elit. Blanditiis voluptatibus!
                                Natus amet voluptatem est dolor, alias fugiat sed praesentium molestias.
                            </Typography>
