...
import { PROGRAMME_DAYS } from './programme-data';
import { ProgrammeActivityItem } from './programme-activity-item';
...
/**
 * Section programme pour les pages d'accueil - Version avec navigation par jours et activités payées
 */
