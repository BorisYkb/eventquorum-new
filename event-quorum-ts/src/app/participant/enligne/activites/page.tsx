...
import { PaymentMethods } from '../../enligne/components/payment-methods';
import { ActivitesSelection } from '../../enligne/components/activites-selection';
...
export default function ParticipantEnligneActivitesPage() {
    ...
    const handleValidatePayment = () => {
        ...
        if (paymentMethod === 'guichet') {
            ...
            router.push('/participant/enligne/payer');
        }
    };
