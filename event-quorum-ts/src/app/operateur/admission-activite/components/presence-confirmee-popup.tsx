// src/app/operateur/admissionactivite/components/presence-confirmee-popup.tsx
...
interface PresenceConfirmeePopupProps {
  open: boolean;
  onClose: () => void;
  ...
  return (
    ...
    >
      ...
      <Box sx={{ p: 4, pt: 5, pb: 4 }}>
        ...
        >
          La présence du participant a été confirmée avec succès
        </Typography>
