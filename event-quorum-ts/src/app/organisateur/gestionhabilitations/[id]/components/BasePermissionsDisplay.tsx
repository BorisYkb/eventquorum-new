// File: src/app/organisateur/gestionhabilitations/[id]/components/BasePermissionsDisplay.tsx
'use client';
...
interface BasePermissionsDisplayProps {
    lecture: boolean;
    ecriture: boolean;
...
/**
 * Composant d'affichage des permissions de base en lecture seule
 * Affiche l'état des permissions Lecture, Écriture, Modification
 */
const BasePermissionsDisplay: React.FC<BasePermissionsDisplayProps> = ({
    lecture,
    ecriture,
    modification
}) => {
...
export default BasePermissionsDisplay;