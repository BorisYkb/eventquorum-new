...
const galleryImages = [
  { id: 1, src: '/assets/img/sara/sara1.jpg', alt: 'Laboratoire de Recherche SARA' },
  { id: 2, src: '/assets/img/sara/sara2.jpeg', alt: 'Conférence principale' },
  { id: 3, src: '/assets/img/sara/sara3.jpeg', alt: 'Networking et échanges' },
  { id: 4, src: '/assets/img/sara/sara4.jpeg', alt: 'Public attentif' },
  { id: 5, src: '/assets/img/sara/sara5.jpg', alt: 'Tests sur le Terrain' },
  { id: 6, src: '/assets/img/sara/sara6.jpg', alt: 'Centre d\'Innovation' },
  { id: 7, src: '/assets/img/sara/sara7.jpg', alt: 'Agriculture Durable' },
		...
		<>
			<style jsx>{`
				...
				.blog-deatils-content ul li .icon {
					margin-right: 8px;
					color: /landing-page/3b82f6;
				}

				.blog-deatils-content h2 {
					font-size: 2.5rem;
					font-weight: bold;
					color: /landing-page/1f2937;
					margin-bottom: 16px;
					line-height: 1.2;
				}
				...
				.thumbnail-active {
					outline: 2px solid /landing-page/3b82f6;
					opacity: 1;
				}
				...
				.cta1-section-area {
					background: /landing-page/f8fafc;
					padding: 60px 0;
				}
