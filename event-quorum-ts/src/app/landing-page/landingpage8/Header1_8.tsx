...
export default function Header1_8({ scroll, isMobileMenu, handleMobileMenu, isSearch, handleSearch }: any) {
							...
							<div className="col-lg-12">
								<div className="header-elements">
									<div className="site-logo">
										<Link href="/landingpage8"><img src="/assets/img/logo/logo6.png" alt="" /></Link>
									</div>
									...
									<div className="main-menu">
										<ul>
											...
											<li><Link href="/landingpage8">Accueil </Link></li>
											<li><Link href="/a_propos_de_levenement8">A propos de l'événement </Link></li>
											<li><Link href="/faq8">FAQ,s</Link></li>
