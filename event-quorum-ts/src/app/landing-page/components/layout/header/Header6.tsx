							...
							<div className="col-lg-12">
								<div className="header-elements">
									<div className="site-logo">
										<Link href="/landing-page/landingpage6"><img src="/assets/img/logo/logo6.png" alt="" /></Link>
									</div>
									<div className="main-menu">
										<ul>
											

											<li><Link href="/landing-page/landingpage6">Accueil </Link></li>
											<li><Link href="/landing-page/about">About Event</Link></li>
											<li><Link href="/landing-page/faq6">FAQ,s</Link></li>
									...
									<div className="btn-area">
										...
										<ul>
											<li>
												<Link href="/landing-page/#"><i className="fa-brands fa-facebook-f" /></Link>
											</li>
											<li>
												<Link href="/landing-page/#"><i className="fa-brands fa-instagram" /></Link>
											</li>
											<li>
												<Link href="/landing-page/#"><i className="fa-brands fa-linkedin-in" /></Link>
											</li>
											<li>
												<Link href="/landing-page/#" className="m-0"><i className="fa-brands fa-pinterest-p" /></Link>
											</li>
										</ul>
									</div>
