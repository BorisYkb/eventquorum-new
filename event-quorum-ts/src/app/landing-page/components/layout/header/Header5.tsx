							...
							<div className="col-lg-12">
								<div className="header-elements">
									<div className="site-logo">
										<Link href="/landing-page/landingpage5"><img src="/assets/img/logo/logo6.png" alt="" /></Link>
									</div>
									<div className="main-menu">
										<ul>
											<li><Link href="/landing-page/landingpage5">Accueil </Link></li>
											<li><Link href="/landing-page/a_propos_de_levenement5">A Propos de l'évènement</Link></li>
											<li><Link href="/landing-page/faq5">FAQ,s</Link></li>
									...
									<li>
										<Link href="/landing-page/inscription5" className="vl-btn4-header4">
