							...
							<div className="col-lg-12">
								...
								<div className="header-elements">
									<div className="site-logo">
										<Link href="/landing-page/landingpage3"><img src="/assets/img/logo/logo6.png" alt="" /></Link>
									</div>
									...
									<div className="main-menu">
										<ul>
											...
											<li><Link href="/landing-page/a_propos_de_levenement3">A Propos de l'évènement</Link></li>
											<li><Link href="/landing-page/faq3">FAQ,s</Link></li>
									...
									<div className='space12'/>
										...
										<li>
											<Link href="/landing-page/inscription3" className="event-btn5">
