...
import Header1_2 from '@/landingpage2/Header1_2'
import Header3 from './header/Header3'
import Header1_3 from '@/landingpage3/Header1_3'
import Header4 from './header/Header4'
import Header1_4 from '@/landingpage4/Header1_4'
import Header5 from './header/Header5'
import Header1_5 from '@/landingpage5/Header1_5'
import Header6 from './header/Header6'
import Header1_6 from '@/landingpage6/Header1_6'
import Header7 from './header/Header7'
import Header1_7 from '@/landingpage7/Header1_7'
import Header8 from './header/Header8'
import Header1_8 from '@/landingpage8/Header1_8'
import Header9 from './header/Header9'
import Header1_9 from '@/landingpage9/Header1_9'
