					...
					<div className="flex items-center justify-between h-20">
						...
						<div className="flex items-center space-x-4">
							<Link 
								...
								className="px-3 py-2 bg-white text-gray-900 font-semibold rounded hover:bg-red-600 transition-colors duration-200 uppercase"
							>
								Connexion
							</Link>
							<Link 
				...
				<nav className="p-6">
					<ul className="space-y-4">
						<li>
							<Link 
								href="/landingpage/landingpage3"
								className="block text-gray-900 hover:text-red-600 font-medium py-2 transition-colors"
								onClick={handleMobileMenu}
							>
								Accueil
							</Link>
