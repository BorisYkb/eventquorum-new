							...
							<div className="col-lg-12">
								<div className="header-elements">
									<div className="site-logo">
										<Link href="/landing-page/landingpage8"><img src="/assets/landing-page/img/logo/logo6.png" alt="" /></Link>
									</div>
									...
									<div className="main-menu">
										<ul>
											...
											<li><Link href="/landing-page/landingpage8/a_propos_de_levenement8">A propos de l'événement </Link></li>
