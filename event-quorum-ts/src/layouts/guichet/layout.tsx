...
import { guichetNavData as dashboardNavData } from '../nav-config-guichet';
...
import { GuichetAccountDrawer } from '../components/guichet/guichet-account-drawer';
    ...
    const headerSlots: HeaderSectionProps['slots'] = {
      leftArea: (
        <>
          ...
          {/* <Logo /> */}
          {/* <Typography variant='h4'>Espace Guichet</Typography> */}
        </>
      ),
      rightArea: (
        <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 0, sm: 0.75 } }}>
          {/** @slot Account drawer */}
          <GuichetAccountDrawer data={_accountIntervenant} />
        </Box>
      ),
    };
