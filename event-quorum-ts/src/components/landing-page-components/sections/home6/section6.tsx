				...
				<div className="container">
					<div className="row">
						<div className="col-lg-6 m-auto">
							<div className="team-heading heading9 text-center space-margin60">
								<h5><img src="/assets/landing-page/img/icons/sub-logo1.svg" alt="" />EVENT SPEAKERS</h5>
					...
					<div className="row">
						<div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-duration={900}>
							<div className="team-widget-area">
								<div className="img1 image-anime">
									<img src="/assets/landing-page/img/all-images/team/team-img20.png" alt="" />
								</div>
								<div className="img2">
						...
						<div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-duration={1000}>
							<div className="team-widget-area">
								<div className="img1 image-anime">
									<img src="/assets/landing-page/img/all-images/team/team-img21.png" alt="" />
								</div>
								<div className="img2">
									<img src="/assets/landing-page/img/elements/brand-img2.png" alt="" />
								</div>
								<div className="content-area">
						...
						<div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-duration={1100}>
							<div className="team-widget-area">
								<div className="img1 image-anime">
									<img src="/assets/landing-page/img/all-images/team/team-img22.png" alt="" />
								</div>
								<div className="img2">
									<img src="/assets/landing-page/img/elements/brand-img3.png" alt="" />
								</div>
								<div className="content-area">
						...
						<div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-duration={1200}>
							<div className="team-widget-area">
								<div className="img1 image-anime">
									<img src="/assets/landing-page/img/all-images/team/team-img23.png" alt="" />
								</div>
								<div className="img2">
									<img src="/assets/landing-page/img/elements/brand-img4.png" alt="" />
								</div>
								<div className="content-area">
