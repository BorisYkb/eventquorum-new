					...
					<div className="row">
						<div className="col-lg-6 m-auto">
							<div className="attent-heading heading9 text-center space-margin60">
								<h5><img src="/assets/landing-page/img/icons/sub-logo1.svg" alt="" />What You Learn</h5>
					...
					<div className="row">
						<div className="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration={800}>
							<div className="skils-widget-boxarea">
								<div className="icons">
									<img src="/assets/landing-page/img/icons/skills1.svg" alt="" />
								</div>
						...
						<div className="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration={1000}>
							<div className="skils-widget-boxarea">
								<div className="icons">
									<img src="/assets/landing-page/img/icons/skills2.svg" alt="" />
								</div>
								<div className="space32" />
								<div className="content-area">
						...
						<div className="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration={1200}>
							<div className="skils-widget-boxarea">
								<div className="icons">
									<img src="/assets/landing-page/img/icons/skills3.svg" alt="" />
								</div>
								<div className="space32" />
								<div className="content-area">
