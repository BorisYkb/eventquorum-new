					...
					<div className="row align-items-center">
							...
							<div className="row">
								<div className="col-lg-6 col-md-6">
									<div className="img1 reveal image-anime">
										...
										<img src="/assets/landing-page/img/all-images/about/about-img14.png" alt="" />
									</div>
									<div className="space30 d-md-none d-block" />
								</div>
								<div className="col-lg-6 col-md-6">
									<div className="img1 reveal image-anime">
										<img src="/assets/landing-page/img/all-images/about/about-img15.png" alt="" />
									</div>
									<div className="img1 reveal image-anime">
										<div className="space30" />
										<img src="/assets/landing-page/img/all-images/about/about-img16.png" alt="" />
									</div>
								</div>
							</div>
						</div>
						<div className="col-lg-6">
							<div className="about6-header heading9">
								<h5 data-aos="fade-left" data-aos-duration={700}><img src="/assets/landing-page/img/icons/sub-logo1.svg" alt="" />About Summit</h5>
								...
								<div className="btn-area1" data-aos="fade-left" data-aos-duration={1200}>
									<Link href="/about" className="vl-btn6">About Event <img src="/assets/landing-page/img/icons/arrow2.svg" alt="" /></Link>
								</div>
							</div>
						</div>
					</div>
