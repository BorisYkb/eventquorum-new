						...
						<div className="col-lg-12">
							<div className="memory-heaer2 heading8 space-margin80">
								<div className="heading8">
									<h5><img src="/assets/landing-page/img/icons/sub-logo1.svg" alt="" /> Event image gallery</h5>
						...
						<div className="col-lg-12 memory-widget-slider5">
							<Swiper {...swiperOptions} className=" owl-carousel">
								<SwiperSlide className="memory-widget-boxarea">
									<div className="img1">
										<img src="/assets/landing-page/img/all-images/memory/memory-img13.png" alt="" />
									</div>
								...
								<SwiperSlide className="memory-widget-boxarea">
									<div className="img1">
										<img src="/assets/landing-page/img/all-images/memory/memory-img14.png" alt="" />
									</div>
									<div className="content-area">
										<Link href="/memories" className="arrow"><i className="fa-solid fa-arrow-right" /></Link>
										<div className="text">
								...
								<SwiperSlide className="memory-widget-boxarea">
									<div className="img1">
										<img src="/assets/landing-page/img/all-images/memory/memory-img15.png" alt="" />
									</div>
									<div className="content-area">
										<Link href="/memories" className="arrow"><i className="fa-solid fa-arrow-right" /></Link>
										<div className="text">
