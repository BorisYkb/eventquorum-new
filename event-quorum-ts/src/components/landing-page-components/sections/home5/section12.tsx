	...
	return (
		<>
			...
			<div className="others5-section-area sp7">
				<img src="/assets/landing-page/img/elements/elements30.png" alt="" className="elements30" />
				<div className="container">
					{/* <div className="row">
						<div className="col-lg-9 m-auto">
							<div className="heading8 text-center space-margin80">
								<h5><img src="/assets/landing-page/img/icons/sub-logo1.svg" alt="" />our event countdown</h5>
