						...
						<div className="col-lg-6">
							<div className="about-header-area heading10">
								...
								<div className="about-auhtor-box" data-aos="fade-left" data-aos-duration={1000}>
									<div className="icons">
										<img src="/assets/landing-page/img/icons/about-icon1.svg" alt="" />
									</div>
									<div className="text">
								...
								<div className="about-auhtor-box" data-aos="fade-left" data-aos-duration={1100}>
									<div className="icons">
										<img src="/assets/landing-page/img/icons/about-icon2.svg" alt="" />
									</div>
									<div className="text">
						...
						<div className="col-lg-6">
							<div className="about-all-images">
								<div className="img1 image-anime reveal">
									<img src="/assets/landing-page/img/all-images/about/about-img17.png" alt="" />
								</div>
								<div className="img2 image-anime reveal">
									<img src="/assets/landing-page/img/all-images/about/about-img18.png" alt="" />
								</div>
								...
								<img src="/assets/landing-page/img/elements/elements37.png" alt="" className="elements37" />
							</div>
						</div>
					</div>
				</div>
