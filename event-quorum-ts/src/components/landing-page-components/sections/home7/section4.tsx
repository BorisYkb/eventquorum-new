				...
				<div className="container">
					...
					<div className="row">
						<div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-duration={900}>
							<div className="vanue-single-item-area">
								<div className="img1 image-anime">
									<img src="/assets/landing-page/img/all-images/others/vanue-img1.png" alt="" />
								</div>
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-duration={1000}>
							<div className="vanue-single-item-area">
								<div className="img1 image-anime">
									<img src="/assets/landing-page/img/all-images/others/vanue-img2.png" alt="" />
								</div>
								<div className="content-area">
									<span>Venue 02</span>
									<div className="space16" />
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-duration={1100}>
							<div className="vanue-single-item-area">
								<div className="img1 image-anime">
									<img src="/assets/landing-page/img/all-images/others/vanue-img3.png" alt="" />
								</div>
								<div className="content-area">
									<span>Venue 03</span>
									<div className="space16" />
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-duration={1200}>
							<div className="vanue-single-item-area">
								<div className="img1 image-anime">
									<img src="/assets/landing-page/img/all-images/others/vanue-img4.png" alt="" />
								</div>
								<div className="content-area">
									<span>Venue 04</span>
									<div className="space16" />
