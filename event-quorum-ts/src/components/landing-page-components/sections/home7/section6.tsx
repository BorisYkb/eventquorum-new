										...
										<div className="row align-items-center">
											<div className="col-lg-6">
												<div className="all-content-area">
													<div className="img1">
														<img src="/assets/landing-page/img/all-images/event/event-img15.png" alt="" />
													</div>
													<div className="content-area">
														<ul>
															<li><Link href="/#"><img src="/assets/landing-page/img/icons/clock1.svg" alt="" /> 10:00
																AM -12:00 PM <span> | </span></Link></li>
															<li><Link href="/#"><img src="/assets/landing-page/img/icons/location1.svg" alt="" />
												...
												<div className="all-content-area">
													<div className="img1">
														<img src="/assets/landing-page/img/all-images/event/event-img16.png" alt="" />
													</div>
													<div className="content-area">
														<ul>
															<li><Link href="/#"><img src="/assets/landing-page/img/icons/clock1.svg" alt="" /> 10:00
												...
												<div className="all-content-area">
													<div className="img1">
														<img src="/assets/landing-page/img/all-images/event/event-img17.png" alt="" />
													</div>
													<div className="content-area">
														<ul>
															<li><Link href="/#"><img src="/assets/landing-page/img/icons/clock1.svg" alt="" /> 10:00
											...
											<div className="col-lg-6">
												<div className="all-content-area">
													<div className="img1">
														<img src="/assets/landing-page/img/all-images/event/event-img18.png" alt="" />
													</div>
													<div className="content-area">
														<ul>
															<li><Link href="/#"><img src="/assets/landing-page/img/icons/clock1.svg" alt="" /> 10:00
												...
												<div className="all-content-area">
													<div className="img1">
														<img src="/assets/landing-page/img/all-images/event/event-img19.png" alt="" />
													</div>
													<div className="content-area">
														<ul>
															<li><Link href="/#"><img src="/assets/landing-page/img/icons/clock1.svg" alt="" /> 10:00
												...
												<div className="all-content-area">
													<div className="img1">
														<img src="/assets/landing-page/img/all-images/event/event-img20.png" alt="" />
													</div>
													<div className="content-area">
														<ul>
															<li><Link href="/#"><img src="/assets/landing-page/img/icons/clock1.svg" alt="" /> 10:00
