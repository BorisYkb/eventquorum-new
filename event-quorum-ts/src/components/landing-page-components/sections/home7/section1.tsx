...
export default function Section1() {
	return (
		<>
			...
			<div className="hero7-section-area" style={{ backgroundImage: 'url(assets/landing-page/img/bg/header-bg18.png)', backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
					...
					<div className="row">
						{/* <div className="col-lg-5 col-md-6">
							<div className="img1 image-anime reveal">
								<img src="/assets/landing-page/img/all-images/hero/hero-img9.png" alt="" />
							</div>
						</div>
						<div className="col-lg-3 col-md-6">
							<div className="img1 image-anime reveal">
								<img src="/assets/landing-page/img/all-images/hero/hero-img10.png" alt="" />
							</div>
						</div> */}
						<div className="col-lg-4">
							<div className="heading-area">
								...
								<div className="btn-area1">
									<Link href="/landing-page/landingpage7/inscription7" className="vl-btn7">S'inscrire</Link>
								</div>
							</div>
						</div>
					</div>
