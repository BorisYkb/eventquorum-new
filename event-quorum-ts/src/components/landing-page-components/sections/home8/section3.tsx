...
export default function Section3() {
	...
	return (
		<>
			...
			<div className="event8-section-area sp1" style={{ backgroundImage: 'url(assets/landing-page/img/bg/header-bg20.png)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
												...
												<div className="event2-boxarea box1">
													<div className="row align-items-center">
														...
														<div className="col-lg-5">
															<div className="img1">
																<img src="/assets/landing-page/img/all-images/event/event-img21.png" alt="" />
															</div>
														</div>
														<div className="space24" />
														<div className="col-gl-12">
															<div className="list">
																...
																<div className="author-area">
																	<p>Speakers:</p>
																	<img src="/assets/landing-page/img/all-images/event/event-img24.png" alt="" />
																</div>
															</div>
														</div>
													</div>
											...
											<div className="col-lg-10 m-auto">
												<div className="event2-boxarea box1">
													<div className="row align-items-center">
														...
														<div className="col-lg-5">
															<div className="img1">
																<img src="/assets/landing-page/img/all-images/event/event-img22.png" alt="" />
															</div>
														</div>
														<div className="space24" />
														<div className="col-gl-12">
											...
											<div className="col-lg-10 m-auto">
												<div className="event2-boxarea box1">
													<div className="row align-items-center">
														...
														<div className="col-lg-5">
															<div className="img1">
																<img src="/assets/landing-page/img/all-images/event/event-img23.png" alt="" />
															</div>
														</div>
														<div className="space24" />
														<div className="col-gl-12">
