							...
							<Swiper {...swiperOptions} className=" owl-carousel">
								<SwiperSlide className="our-team-boxarea">
									<div className="team-widget-area">
										{/* <img src="/assets/landing-page/img/elements/elements21.png" alt="" className="elements21" />
										<img src="/assets/landing-page/img/elements/elements22.png" alt="" className="elements22" /> */}
										<div className="img1" style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
											<img src="/assets/landing-page/img/all-images/team/femme.jpg" alt="" className="team-img4" />
