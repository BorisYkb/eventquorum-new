						...
						<div className="col-lg-12">
									...
									<div className="col-lg-5">
										<div className="content-area">
											...
											<div className="btn-area1">
												<Link href="/pricing-plan" className="vl-btn10">Buy Tickets Now <img src="/assets/landing-page/img/icons/arrow2.svg" alt="" /></Link>
											</div>
										</div>
									</div>
								</div>
							...
							<div className="event6-widget-boxarea" data-aos="fade-right" data-aos-duration={1100}>
								<div className="row align-items-center">
									<div className="col-lg-7">
										<div className="img1 image-anime reveal">
											<img src="/assets/landing-page/img/all-images/event/event-img26.png" alt="" />
										</div>
									</div>
									<div className="col-lg-5">
										<div className="content-area">
