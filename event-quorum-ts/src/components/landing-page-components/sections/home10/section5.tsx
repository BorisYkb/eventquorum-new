					...
					<div className="row">
						<div className="col-lg-6 m-auto">
							<div className="heading13 text-center space-margin60">
								<h5><img src="/assets/landing-page/img/icons/sub-logo1.svg" alt="" />our speaker</h5>
						...
						<div className="col-lg-4">
							<div className="team10-widget-boxarea">
								<div className="img1 image-anime">
									<img src="/assets/landing-page/img/all-images/team/team-img38.png" alt="" />
								</div>
							...
							<div className="row">
								<div className="col-lg-4 col-md-6">
									<div className="team10-widget-boxarea2">
										<div className="img1 image-anime">
											<img src="/assets/landing-page/img/all-images/team/team-img39.png" alt="" />
										</div>
										<div className="text-area">
								...
								<div className="col-lg-4 col-md-6">
									<div className="team10-widget-boxarea2">
										<div className="img1 image-anime">
											<img src="/assets/landing-page/img/all-images/team/team-img40.png" alt="" />
										</div>
										<div className="text-area">
								...
								<div className="col-lg-4 col-md-6">
									<div className="team10-widget-boxarea2">
										<div className="img1 image-anime">
											<img src="/assets/landing-page/img/all-images/team/team-img41.png" alt="" />
										</div>
										<div className="text-area">
								...
								<div className="col-lg-4 col-md-6">
									<div className="team10-widget-boxarea2">
										<div className="img1 image-anime">
											<img src="/assets/landing-page/img/all-images/team/team-img42.png" alt="" />
										</div>
										<div className="text-area">
								...
								<div className="col-lg-4 col-md-6">
									<div className="team10-widget-boxarea2">
										<div className="img1 image-anime">
											<img src="/assets/landing-page/img/all-images/team/team-img43.png" alt="" />
										</div>
										<div className="text-area">
								...
								<div className="col-lg-4 col-md-6">
									<div className="team10-widget-boxarea2">
										<div className="img1 image-anime">
											<img src="/assets/landing-page/img/all-images/team/team-img44.png" alt="" />
										</div>
										<div className="text-area">
