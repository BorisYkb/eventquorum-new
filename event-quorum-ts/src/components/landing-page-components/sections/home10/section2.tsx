					...
					<div className="row align-items-center">
						<div className="col-lg-6">
							<div className="about10-images">
								<img src="/assets/landing-page/img/all-images/others/author-img2.png" alt="" className="about-img10 aniamtion-key-1" />
								<div className="img1" data-aos="zoom-in" data-aos-duration={1000}>
									<img src="/assets/landing-page/img/all-images/about/about-img7.png" alt="" />
								</div>
								...
								<div className="img3" data-aos="zoom-in" data-aos-duration={1200}>
									<img src="/assets/landing-page/img/all-images/about/about-img9.png" alt="" />
								</div>
							</div>
						</div>
						<div className="col-lg-6">
							<div className="about-header heading13">
								<h5 data-aos="fade-left" data-aos-duration={800}><img src="/assets/landing-page/img/icons/sub-logo1.svg" alt="" /> About Summit</h5>
								...
								<div className="btn-area1" data-aos="fade-left" data-aos-duration={1200}>
									<Link href="/event-schedule" className="vl-btn10">About Form <img src="/assets/landing-page/img/icons/arrow2.svg" alt="" /></Link>
								</div>
							</div>
						</div>
					</div>
