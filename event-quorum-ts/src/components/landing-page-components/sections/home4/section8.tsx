						...
						<div className="col-lg-6">
							<div className="contact4-header heading7">
								...
								<div className="contact-author-box" data-aos="fade-left" data-aos-duration={1200}>
									<div className="icons">
										<img src="/assets/landing-page/img/icons/clock1.svg" alt="" />
									</div>
									<div className="text">
										<h4>Schedule</h4>
										<div className="space10" />
					...
					<div className="row">
						<div className="col-lg-3 col-md-6">
							<div className="img1 image-anime reveal">
								<img src="/assets/landing-page/img/all-images/contact/contact-img2.png" alt="" />
							</div>
						</div>
						<div className="col-lg-4 col-md-6">
							<div className="img1 image-anime reveal">
								<img src="/assets/landing-page/img/all-images/contact/contact-img3.png" alt="" />
							</div>
						</div>
