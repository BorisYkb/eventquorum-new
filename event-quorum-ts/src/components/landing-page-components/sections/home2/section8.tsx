						...
						<div className="col-lg-5">
							<div className="contact-boxs-area" data-aos="zoom-in" data-aos-duration={1000}>
								<div className="contact-auhtor-box">
									<div className="icons">
										<img src="/assets/landing-page/img/icons/mail2.svg" alt="" />
									</div>
									<div className="text">
										<h4>Our Email</h4>
								...
								<div className="contact-auhtor-box">
									<div className="icons">
										<img src="/assets/landing-page/img/icons/phn2.svg" alt="" />
									</div>
									<div className="text">
										<h4>Call/Message</h4>
										<div className="space14" />
								...
								<div className="contact-auhtor-box">
									<div className="icons">
										<img src="/assets/landing-page/img/icons/clock2.svg" alt="" />
									</div>
									<div className="text">
										<h4>Schedule</h4>
										<div className="space14" />
