					...
					<div className="row">
						<div className="col-lg-3 col-md-6">
							<div className="footer-logo-area">
								<img src="/assets/landing-page/img/logo/logo2.png" alt="" />
						...
						<div className="col-lg-3 col-md-6">
							<div className="link-content2">
								<h3>Contact Us</h3>
								<ul>
									<li><Link href="/tel:+11234567890"><img src="/assets/landing-page/img/icons/phn1.svg" alt="" />+1 123 456
										7890</Link></li>
									<li><Link href="/#"><img src="/assets/landing-page/img/icons/location1.svg" alt="" />Secret Location In The
										UK</Link></li>
									<li><Link href="/mailto:eventifyevent@gmail.com"><img src="/assets/landing-page/img/icons/mail1.svg" alt="" />eventifyevent@gmail.com</Link></li>
									<li><Link href="/#"> <img src="/assets/landing-page/img/icons/world1.svg" alt="" />eventifyevent.com</Link></li>
								</ul>
							</div>
						</div>
