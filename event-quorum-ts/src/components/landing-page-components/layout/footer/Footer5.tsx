	...
	return (
		<>
			<div className="footer5-sertion-area">
					...
					<div className="row display-flex justify-content-around">
						...
						<div className="col-lg-3 col-md-6">
							<div className="link-content2">
								...
								<ul>
									<li>
										<Link href="/tel:+2250749668962"><img src="/assets/landing-page/img/icons/phn1.svg" alt="" />+225 0749668962</Link>
									</li>
									<li>
										<Link href="/#"><img src="/assets/landing-page/img/icons/location1.svg" alt="" />Abidjan Plateau</Link>
									</li>
									<li>
										<Link href="/mailto:eventifyevent@gmail.com"><img src="/assets/landing-page/img/icons/mail1.svg" alt="" />eventify@gmail.com</Link>
									</li>
				...
				<img src="/assets/landing-page/img/elements/elements33.png" alt="" className="elements33" />
			</div>
