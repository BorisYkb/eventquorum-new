				...
				<div className="mobile-nav mobile-nav1">
					<ul className="mobile-nav-list nav-list1">
						<li className="has-sub hash-has-sub">
							<Link href="/landing-page/landingpage2" className="hash-nav">Accueil </Link>
							
						</li>
						<li className="hash-has-sub"><Link href="/landing-page/landingpage2/a_propos_de_levenement2" className="hash-nav">A propos de l'événement</Link></li>
						<li className="hash-has-sub"><Link href="/landing-page/landingpage2/faq2" className="hash-nav">FAQ,s</Link></li>
