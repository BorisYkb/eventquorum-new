			...
			<div id="popup" className="popup-overlay">
				<div className="popup-content">
					...
					<div className="popup-icon">
						<img src="/assets/landing-page/img/logo/popup-logo.png" alt="" />
					</div>
					...
					<div className="heading2">
						...
						<ul>
							<li><img src="/assets/landing-page/img/icons/check3.svg" alt="" />Elevate User Experience Expertise</li>
							<li><img src="/assets/landing-page/img/icons/check3.svg" alt="" /> Elevate Your UI/UX Skills Designer</li>
							<li><img src="/assets/landing-page/img/icons/check3.svg" alt="" />Join Leading UI/UX Event the Year</li>
						</ul>
					</div>
