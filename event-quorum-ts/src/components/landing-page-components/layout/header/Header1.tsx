							...
							<div className="col-lg-12">
								<div className="header-elements">
									<div className="site-logo">
										<Link href="/landingpage/"><img src="/assets/landing-page/img/logo/logo6.png" alt="" /></Link>
									</div>
									<div className='space12' />
									<div className="main-menu">
										<ul>
											<li><Link href="/landingpage/">Accueil </Link></li>
											<li><Link href="/landingpage/a_propos_de_levenement">A propos de l'événement </Link></li>
									...
									<li>
										<Link href="/landingpage/inscription" className="vl-btn1">
