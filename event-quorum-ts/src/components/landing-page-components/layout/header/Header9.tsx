							...
							<div className="col-lg-12">
								<div className="header-elements">
									<div className="site-logo">
										<Link href="/landingpage/landingpage9"><img src="/assets/landing-page/img/logo/logo1.png" alt="" /></Link>
									</div>
									<div className="main-menu">
										<ul>
											<li><Link href="/landingpage/landingpage9">Accueil </Link></li>
											<li><Link href="/landingpage/landingpage9/a_propos_de_levenement9">About Event</Link></li>
											<li><Link href="/landingpage/landingpage9/faq9">FAQ,s</Link></li>
